      ...
      <div class="col-sm-6">
        ...
        <div class="form-group inline-checks-container">
          ...
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="checkbox" id="platformCheckbox{{ $p->id }}" value="{{ $p->id }}" name="platform_id" {{ ($p->id == 1) ? 'checked' : '' }} required>
        ...
        <div class="form-group">
          ...
          @foreach( $dev_statuses as $dev_status )
            <div class="form-check">
              <input class="form-check-input" name="development_status_id" type="radio" value="{{ $dev_status->id }}" id="defaultCheck{{ $dev_status->id }} " {{ ($dev_status->id == 1) ? 'checked' : '' }}>
